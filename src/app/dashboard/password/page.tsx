...
const password = () => {
 ...
 <p className="font- text-slate-600">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p> 
          ...
          <p className="mt-2">Can&apso;t  remember your current password. <Link  className="text-sm font-semibold text-blue-600 underline decoration-2" href="/">Recover Account</Link></p>
