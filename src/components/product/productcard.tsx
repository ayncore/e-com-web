                ...
                <div className="grid items-start grid-cols-1 lg:grid-cols-2 gap-8 max-lg:gap-16">
                    <div className="w-full lg:sticky top-0 text-center">
                        <div className="lg:h-[560px]">
                            <Image height={100} width={100} src="https://readymadeui.com/images/product6.webp" alt="Product" className="lg:w-11/12 w-full h-full rounded-md object-cover object-top" />
                        </div>
                        <div className="flex flex-wrap gap-4 justify-center mx-auto mt-4">
                            <Image height={100} width={1007} src="https://readymadeui.com/images/product6.webp" alt="Product1" className="w-16 cursor-pointer rounded-md outline" />
                            <Image height={100} width={1007} src="https://readymadeui.com/images/product8.webp" alt="Product2" className="w-16 cursor-pointer rounded-md" />
                            <Image height={100} width={1007} src="https://readymadeui.com/images/product5.webp" alt="Product3" className="w-16 cursor-pointer rounded-md" />
                            <Image height={100} width={1007} src="https://readymadeui.com/images/product7.webp" alt="Product4" className="w-16 cursor-pointer rounded-md" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-4 items-start">
                            <div>
                                ...
                                <p className="text-gray-500 text-sm mt-2"><b>$42</b> <span className="text-sm ml-1">Tax included</span></p>
                            </div>
