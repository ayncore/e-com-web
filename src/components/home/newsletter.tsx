...
import character from "@/assets/ayncorelogo.png";
      ...
      <div className="left flex-1 p-16">
        ...
        <ul className="space-y-4">
          <li className="1 flex gap-5 items-center mt-10 text-neutral-700 font-medium">
            <span className="bg-purple-200 rounded-full text-xs px-2.5 py-1">
              01
            </span>
            <h1>Savings combos</h1>
          </li>
          <li className="1 flex gap-5 items-center mt-10 text-neutral-700 font-medium">
            <span className="bg-blue-200 rounded-full text-xs px-2.5 py-1">
              02
            </span>
            <h1>Freeship</h1>
          </li>
          <li className="1 flex gap-5 items-center mt-10 text-neutral-700 font-medium">
            <span className="bg-red-200 rounded-full text-xs px-2.5 py-1">
              03
            </span>
        ...
        <form action="" className="relative mt-10 max-w-sm">
          <input
            type="text"
            className="rounded-full px-4 py-3 h-10 text-sm font-normal text-neutral-700 block w-full border border-neutral-200 focus:border-primary-300 focus:ring focus:ring-primary-200 focus:ring-opacity-50 bg-white outline-none"
